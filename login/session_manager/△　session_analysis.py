...
def analyze_sessions(user_uuid: str) -> dict:
    """
    指定されたユーザーのセッション履歴から、平均ログイン間隔、最終ログイン時間、セッション件数を分析します。
    """
    ...
    try:
        ...
        if not sessions:
            return {"message": "No sessions found", "average_interval": None, "last_login": None}
        
        # login_time を ISO 8601 形式と仮定して並べ替え
